...
1. Create a new directory, navigate to that directory in a terminal and enter ```https://github.com/nihar-ranjan-samantaray/amazon-eventbridge-producer-consumer-example-1```.
